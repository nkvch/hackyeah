...
- ⚠️ Unit/Integration tests deferred (to be added in follow-up)
...
- `src/Backend/Api/UknfPlatform.Api/Controllers/AuthController.cs` (added activate and resend-activation endpoints)
- `src/Backend/Api/UknfPlatform.Api/Program.cs` (registered new services)
