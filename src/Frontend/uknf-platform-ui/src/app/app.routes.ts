...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/auth/resend-activation/resend-activation.component').then(
        (m) => m.ResendActivationComponent,
      ),
  },
  {
    path: 'set-password',
  ...
  },
  {
    path: 'access-request',
    loadComponent: () =>
      import('./features/access-request/my-access-request/my-access-request.component').then(
        (m) => m.MyAccessRequestComponent,
      ),
  ...
  },
  {
    path: 'reports/submit',
    loadComponent: () =>
      import('./features/reporting/submit-report/submit-report.component').then(
  ...
  },
  {
    path: 'messages',
    loadComponent: () =>
      import('./features/messaging/messages-list/messages-list.component').then(
        (m) => m.MessagesListComponent,
      ),
    canActivate: [authGuard], // Story 5.2: View Messages List
  },
  {
    path: 'messages/compose',
    loadComponent: () =>
      import('./features/messaging/compose-message/compose-message.component').then(
        (m) => m.ComposeMessageComponent,
      ),
    canActivate: [authGuard], // Story 5.1: Send Message with Attachments
  },
  {
    path: 'messages/:id',
    loadComponent: () =>
      import('./features/messaging/message-detail/message-detail.component').then(
        (m) => m.MessageDetailComponent,
      ),
    canActivate: [authGuard], // Story 5.2: View Message Detail
  },
